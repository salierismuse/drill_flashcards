...
- **Rich Text Support**: Markdown rendering (including chem formulas: `H~2~O` → H₂O and images via paste).
- **Image Support**: Paste images directly into cards to auto-generate markdown.
